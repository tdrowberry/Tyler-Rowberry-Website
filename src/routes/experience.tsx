...
function ExperiencePage() {
  return (
    <main className="mx-auto max-w-6xl px-5 sm:px-8">
      <PageIntro eyebrow="02 / Career record" title={<>Strategy in practice,<br /><span className="font-body font-normal italic text-muted-foreground">from diligence to transformation.</span></>}>
